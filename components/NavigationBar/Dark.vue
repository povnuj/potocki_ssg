<template>
  <header class='flex' id="mainHeader" v-bind:class="{ 'header-white': isDarkNav }">
      <div class="content-wrap header-wrap flex space-btw">
        <nav class="flex space-btw">
          <div class="header__logo">
            <NuxtLinkLocale id="logoLink" to="index">  
              <img alt="Potocki palace" id="logoImgWhite" v-if="($route.path === '/')"
                   :src='
                      isDarkNav
                      ? logoSrc
                      : logoSrcWhite
          ...
          <div class="header__menu">
            <ul class="menu-list flex">
              <li class="fw-700">
                <router-link to="/citta-landing">Citta Ideale</router-link>
              </li>
              ...
              <li>
                <router-link to="/blogs">{{ $t('nav.blog') }}</router-link>
              </li>
              <li>
            ...
            <ul class="menu-list flex">
              <li class="lang-switch-mob-container">
                ...
                <div class="header__contest-mob font-roboto-18">
                  ...
                  <router-link to="/contest">{{ $t('nav.contest') }}</router-link>
                </div>
              </li>
              <li class="fw-700">
                <router-link to="/citta-landing" class="uppercase">Citta Ideale</router-link>
              </li>
 
              <li>
                <router-link to="/events" class="uppercase">{{ $t('nav.events') }}</router-link>
              </li>
              <li>
                <router-link to="/projects" class="uppercase">{{ $t('nav.projects') }}</router-link>
              </li>
              <li>
                <router-link to="/services" class="uppercase">{{ $t('nav.services') }}</router-link>
              </li>
              <li>
                <router-link to="/blogs" class="uppercase">{{ $t('nav.blog') }}</router-link>
              </li>
              <li>
                <router-link to="/contacts" class="uppercase">{{ $t('nav.contacts') }}</router-link>
              </li>
            </ul>
          </div>
        </nav>
...
import logoSrcWhite from '@/assets/images/main-logo-white.svg';
