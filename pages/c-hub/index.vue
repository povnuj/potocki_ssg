<template>
  <div class="events-page c-events-page hub-page content-wrap">
      ...
      <div class="events-row future-events flex flex-wrap space-btw">
        <div class="events-row__item" v-for="(event, index) in eventsRecent" v-bind:key="index">
          ...
          <div class="item__footer">
            ...
            <NuxtLink
                :to="{path: '/'+$i18n.locale+'/c-hub-page', query:{type: 'recent', id: event.id}}"
                class="btn-details"
            >
              {{ $t('events.details') }}
      ...
      <div class="events-row past-events flex flex-wrap space-btw">
        <div class="events-row__item" v-for="(event, index) in eventsPast" v-bind:key="index">
          ...
          <div class="item__footer">
            ...
            <NuxtLink
                :to="{path: '/'+$i18n.locale+'/c-hub-page', query:{type: 'past', id: event.id}}"
                class="btn-details"
            >
              {{ $t('events.details') }}
              <span class="btn-details__icon"></span>
...
.events-page {
  .page-header {
    ...
    &-img {
      ...
      max-width: 570px;
      height: 228px;
      background-image: url("~@/assets/images/citta/hub/hub-header.svg");
    }
  }
}
