        ...
        <div class="row-vue space-btw">
          ...
          <div class="row-vue__item text-item">
            ...
            <NuxtLink to='/restoration' class="hide-mobile">
              <Button v-html="$t('home.restBtn')"></Button>
            </NuxtLink>
        ...
        <div class="row-vue">
          <div class="section-text">
            ...
            <NuxtLink to='/events' class="hide-mobile">
              <Button v-html="$t('home.eventsBtn')"></Button>
            </NuxtLink>
          </div>
...
<!--              <div className="keen-slider__slide" v-for="(slide, index) in carouselEvents" :key="index">-->
    ...
    <section class="section-services">
      <div class="content-wrap">
        ...
        <NuxtLink to='/services' class="">
          <Button v-html="$t('home.servicesBtn')"></Button>
        </NuxtLink>
      </div>
    </section>
  </div>
...
//import 'vue3-carousel-nuxt/dist/carousel.css'
//import { Carousel, Slide, Navigation } from 'vue3-carousel-nuxt'
...
export default {
  ...
  layout: "default",
   ...
   data () {
    return {
      btnText:'Усі події',
      btnRestoration: 'Інтерактивна схема реставрації',
      btnServices: 'Більше про послуги',
      isMain: true,
      info: null,
      servicesList: [],
      carouselEvents: [],
      ...
      carouselEvents1: [
        // {attributes: {main_image: process.env.VUE_APP_API+'/uploads/event/main_image/63bd6733192ec000012f6b0f/1619683550_35677.jpg'} },
        // {attributes: {main_image: process.env.VUE_APP_API+'/uploads/event/main_image/63bd6733192ec000012f6b0f/1619683550_35677.jpg'} },
        // {attributes: {main_image: process.env.VUE_APP_API+'/uploads/event/main_image/63bd6733192ec000012f6b0f/1619683550_35677.jpg'} },
        // {attributes: {main_image: process.env.VUE_APP_API+'/uploads/event/main_image/63bd6733192ec000012f6b0f/1619683550_35677.jpg'} },
        // {attributes: {main_image: process.env.VUE_APP_API+'/uploads/event/main_image/63bd6733192ec000012f6b0f/1619683550_35677.jpg'} }
  ...
  methods: {
    ...
    getCarouselEvents(){
      this.$axios
          ...
          .then(response => {
            this.carouselEvents = response.data.data
          })
          .catch(error => {
            console.log(error)
          })
