<template>
    <div class="services-page content-wrap">
        ...
        <a href="/2023_3.pdf" target="_blank">
            <ButtonDownload>{{ $t('services.servicesBtn') }}</ButtonDownload>
...
useSeoMeta({
    title: t('meta.palace.services.title'),
    ogTitle: t('meta.palace.services.title'),
    description: t('meta.palace.services.description'),
    ogDescription: t('meta.palace.services.description'),
...
.services-page {
    .page-header {
        ...
        &-img {
            width: 570px;
            height: 228px;
            background-image: url("@/public/images/services-header-img.svg");
        }
    }
    ...
    .services-grid {
        ...
        .services-grid-item:nth-child(3n+1) {
            &:after {
                background-image: url("@/public/images/service-item-frame-1.svg");
            }

            @media (max-width: 446px) {
                &:after {
                    background-image: url("@/public/images/service-item-frame-1-m.svg");
                }
            }
        }
        ...
        .services-grid-item:nth-child(3n+2) {
            &:after {
                background-image: url("@/public/images/service-item-frame-2.svg");
            }

            @media (max-width: 446px) {
                &:after {
                    background-image: url("@/public/images/service-item-frame-2-m.svg");
                }
            }
        }
        ...
        .services-grid-item:nth-child(3n+3) {
            &:after {
                background-image: url("@/public/images/service-item-frame-3.svg");
            }

            @media (max-width: 446px) {
                &:after {
                    background-image: url("@/public/images/service-item-frame-3-m.svg");
                }
            }
        }
